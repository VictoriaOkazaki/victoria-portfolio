...
<i18n lang="json">
{
    "en": {
        ...
        "job-5": "website layout based on a ready-made Figma design using code",
        "job-6": "connecting animations",
        "job-7": "making adaptation of websites for various devices",
        "job-8": "building layouts on Tilda using Zero blocks (i work also with Flexbe and Webflow);",
        "job-9": "development of an admin panel for content management",
    ...
    "ru": {
        ...
        "job-5": "вёрстку сайта по готовому макету в Figma с использованием кода",
        "job-6": "подключение анимаций",
        "job-7": "адаптацию сайта для различных устройств",
        "job-8": "создание сайта на Tilda с использованием зеро-блоков (также работаю с Flexbe и Webflow)",
        "job-9": "разработку админ-панели для управления контентом",
