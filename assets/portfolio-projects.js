export default [
  ...
  // },
  {
    "description": "I wrote texts according to the structure provided by the customer, translated into Spanish using ChatGPT. I created a prototype and designed the website using standard blocks in Tilda. Almost all the photos on the site were generated by me using neural networks.",
    "id": "fhdjhg587ddd55k",
    "is_my_design": true,
    "link": "http://soldorado.tilda.ws",
    "name": "Sol De Oro",
    "photo": "site-covers/soldorado.webp",
    "ru_description": "Написала тексты по предоставленной заказчиком структуре, перевела на испанский язык с помощью ChatGPT. Создала прототип, сверстала сайт, используя стандартные блоки в Тильде. Почти все фото на сайте сгененированы мной с иcпользованием нейросетей."
  },
  {
